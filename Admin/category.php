                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="catname" name="cat_name" class="form-control" placeholder="Category Name" required>
                                                </div>   
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Category Image</label>
                                                    <input type="file" id="catimg" name="catimg" class="form-control" required="">
                                                    </div>      
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" id="cat_desc" name="cat_desc" class="form-control " rows="10" ></textarea>
                                                    </div>      
                                            </div>
                                            <!--/span-->
        ...
        <script>
            $(document).ready(function(){
                $("#catform").on("submit",function(event){
                    ...
                    $.ajax({  
                        url:"processData.php?task=addCategory",  
                        method:"POST",  
                        data: formData,  
                        ...
                        success:function(data){  
                            $("#status").html("Category Added Successfully..");
